...
**Tiktok Scraper** — TikTok Scraper - Collect public video, creator, hashtag, and engagement metadata for research

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/tiktok-scraper?style=social)
...
>
> **Search intent:** collect public TikTok data for creator research, content analysis, and social listening. Related topics: tiktok data, creator research, social media data, python, data extraction.

## What this project is for

`tiktok-scraper` is an implementation-focused Python project for collecting public TikTok data. It is designed around one practical job: turn a query such as **"AI productivity"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/tiktok-scraper.git
cd tiktok-scraper
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "TikTok", "category": "TikTok Scrapers"}
  }
}
```
